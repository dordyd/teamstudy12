...
//    }
    ...
    @Override
    public String toString() {
        return Arrays.toString(this.residents);
    }

    public void savetoFile(Apartment apartment) throws IOException {
        PrintWriter pw = new PrintWriter(new FileWriter("ApartmentInfo.txt"));

        pw.println(apartment.address);
        pw.println(apartment.size);
        pw.println(Arrays.toString(apartment.residents));
        pw.println(apartment.numberOfResidents);
    ...
    public static void main(String[] args) throws IOException {
        ...
        //Exercise08_8
        apartment.savetoFile(apartment);
