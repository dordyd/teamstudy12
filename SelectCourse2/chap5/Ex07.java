...
public class Ex07 {
    private static Question.SubtractionQuestion[] ques;
    static int[] a = new int[10];
    static int[] b = new int[10];
    static int[] ans = new int[10];

    public static void randomQuiz(int a[], int b[]) {
        ques = new Question.SubtractionQuestion[10];
        for (int i = 0; i < 9; i++) {
            ques[i] = new Question.SubtractionQuestion();
        }
        ques[9] = new Question.SubtractionQuestion() {
