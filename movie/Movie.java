...
//
//public class Movie {
//    private Category ID, releaseYear, runningTime,
...
//    }
//
////    public Movie(String ID, String title, String koreanTitle,
////                 String plot, String releaseYear, String runningTime, String gradeID,
////                 String gradeKoreanID, String poster, String releaseDateInKorea, String boxOfficeWWGross,
////                 String boxOfficeUSGross, String budget, String author, String originalSource){
////        this.ID = ID;
////        this.title = title;
...
//    }
//
//    public static Comparator<Movie> comparator(String string){
//        return Collections.sort((e1, e2) -> e1.)
//    }
//
